...
# # print(avg_salary)
# # df_clean['Salary'].plot(kind='line', title='Employee Salaries')
...
# # dept_counts.plot(kind='pie', startangle=90, title='Employee Distribution by Department')
# # plt.ylabel('')  # Hide the y-label
# # plt.show()
# name=df_clean.loc[99,"Name"]
# print
